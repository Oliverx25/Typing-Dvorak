  ...
  return (
    <div className="absolute inset-0 z-10 flex items-center justify-center rounded-2xl bg-[var(--color-surface)]/80 backdrop-blur-sm">
      <div className="text-center">
        <div className="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-full bg-[var(--color-highlight)]/15 ring-2 ring-[var(--color-highlight)]/25">
        ...
        <button
          type="button"
          onClick={onResume}
          className="mt-6 rounded-xl bg-[var(--color-highlight)] px-6 py-2.5 text-sm font-semibold text-white transition hover:bg-[var(--color-highlight-hover)]"
        >
          {t.lesson.resume}
        </button>
      </div>
