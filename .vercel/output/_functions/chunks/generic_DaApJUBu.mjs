...
import { a as isRemoteImage, i as isESMImportedImage, n as fetchWithRedirects, o as resolveSrc, s as isRemoteAllowed, t as inferRemoteSize } from "./remoteProbe_C7-LKqCd.mjs";
import { A as createComponent, D as unescapeHTML, E as addAttribute, _ as spreadAttributes, k as createAstro, ut as isRemotePath, w as maybeRenderHead, x as renderTemplate } from "./render_5Y2nopdm.mjs";
import { a as DEFAULT_HASH_PROPS, i as resolveDefaultOutputFormat, n as isLocalService } from "./service_DhgT7mik.mjs";
...
async function getConfiguredImageService() {
	if (!globalThis?.astroAsset?.imageService) {
		const { default: service } = await import("./sharp_uWwBainP.mjs").catch((e) => {
