...
export const es: TranslationKey = {
  ...
  home: {
    ...
    heatmapDesc: 'Color según precisión (aciertos vs errores). Rojo = más fallos; verde = dominada.',
    ...
    masteryRequirementsTest: 'Requiere {wpm} WPM y {accuracy}% en modo Test',
    masteryRequirementsTestGrade: 'Requiere {wpm} WPM, {accuracy}% y rango {grade}+ en modo Test',
  ...
  sandbox: {
    graduationBadge: 'Roadmap completado',
    title: 'Entrenamiento libre',
    desc: 'Configura tu sesión — tiempo o palabras, idioma y modificadores.',
    sessionDesc: 'Sesión sandbox — sin presión de desbloqueo, solo práctica.',
    modeLabel: 'Modo',
    modeTime: 'Tiempo',
    modeWords: 'Palabras',
  ...
  practice: {
    ...
    lyricsDirtyHint: 'Haz clic o presiona Enter para empezar a teclear la letra',
    lyricsChangeSong: 'Cambiar canción',
  ...
  achievements: {
    ...
    categoryPrecision: 'Precisión y Flujo',
    categoryMultiplayer: 'Multijugador',
    categoryRisk: 'Riesgo y Recompensa',
    categoryTechnique: 'Técnica',
    categoryEndurance: 'Resistencia',
    categoryMusic: 'Música',
    categoryRanks: 'Rangos',
    toastUnlocked: 'Logro desbloqueado',
    toastDismiss: 'Cerrar notificación',
    toastRegionLabel: 'Notificaciones de logros',
  },
  lesson: {
    practice: 'Práctica',
    test: 'Test',
    ...
    zenStartHint: 'Escribe libremente · Esc para terminar la sesión',
  },
  stats: {
    title: 'Tu progreso',
    ...
    sortWpmAsc: 'Peor PPM primero',
    sortWpmDesc: 'Mejor PPM primero',
    sortAccAsc: 'Peor precisión primero',
    ...
    heatmapTooltipKey: 'Tecla: {labels}',
    heatmapTooltipBase: 'Base ({char})',
    heatmapTooltipShift: 'Shift ({char})',
    heatmapTooltipTotal: 'Total ({char})',
    ...
    insights: {
      needsSpeed: 'Necesita velocidad',
      needsAccuracy: 'Necesita precisión',
      suggestedAdaptive: 'Sugerido: Ejercicio adaptativo',
      suggestedRetry: 'Sugerido: Repetir lección',
      focusOnKeys: 'Enfócate en: {keys}',
      improveOnLesson: 'Mejora tu puntuación en {lesson}',
  ...
  settings: {
    ...
    guestHint: 'Los ajustes se guardan en este dispositivo. Inicia sesión para sincronizar tus preferencias entre dispositivos.',
    ...
    hardwareLayout: 'Disposición física',
    hardwareLayoutDesc: 'Posición real de las teclas en el teclado en pantalla (el mapeo Dvorak no cambia).',
    hardwareLayoutAnsi: 'ANSI (EE. UU.)',
    hardwareLayoutMacIso: 'ISO (Mac ES/EU)',
    osPreference: 'Sistema operativo',
    osPreferenceDesc: 'Etiquetas de modificadores en el teclado en pantalla (⌘/⌥ vs Win/Alt).',
    osPreferenceMac: 'macOS',
    osPreferenceWindows: 'Windows',
    ...
    caretStyle: 'Estilo del cursor',
    caretStyleDesc: 'Apariencia del cursor de escritura.',
    caretLine: 'Línea',
    caretBlock: 'Bloque',
    caretUnderline: 'Subrayado',
    caretAnimation: 'Animación del cursor',
    caretAnimationDesc: 'Movimiento suave o parpadeo clásico.',
    caretSmooth: 'Suave',
    caretBlink: 'Parpadeo',
    caretOff: 'Apagado',
    stopOnError: 'Parar en error',
    stopOnErrorDesc: 'No avanzar hasta corregir la tecla incorrecta.',
    stopOnWord: 'Parar en palabra',
    stopOnWordDesc: 'Bloquea el espacio si la palabra actual tiene errores.',
  },
  categories: {
  ...
  completion: {
    ...
    keystrokeDistribution: 'Distribución de pulsaciones',
    keystrokesCorrect: 'Correctas',
    keystrokesCorrected: 'Corregidas',
    keystrokesErrors: 'Errores',
    keystrokesErrorsNa: 'El conteo de errores no está disponible con parar en error activo.',
    starsEarned: 'Estrellas obtenidas',
  },
  history: {
    title: 'Historial de sesiones',
    subtitle: 'Revisa tus sesiones anteriores y consulta los detalles.',
    viewHistory: 'Historial',
    viewDetails: 'Ver detalles',
    closeDetails: 'Cerrar',
    noSessions: 'Aún no hay sesiones. Completa una lección para empezar tu historial.',
    emptyTitle: 'Tu recorrido empieza aquí',
    emptyDesc: 'Completa tu primera lección y tus sesiones aparecerán en este carrusel.',
    emptyCta: 'Empezar primera lección',
    loadingMore: 'Cargando más sesiones…',
    guestHint: 'Inicia sesión para sincronizar tu historial entre dispositivos.',
    today: 'Hoy',
    yesterday: 'Ayer',
    ...
    loadingTelemetry: 'Cargando análisis de la sesión…',
    page: 'Página {page} de {total}',
    previous: 'Anterior',
    next: 'Siguiente',
    sessionDetail: 'Detalles de la sesión',
    score: 'Puntuación',
    maxCombo: 'Combo máx.',
  },
  fingers: {
  ...
  multiplayer: {
    ...
    modifierSuddenDeath: 'Muerte súbita',
    modifierSuddenDeathDesc: 'Un error te elimina.',
    modifierBlindMode: 'Modo ciego',
    modifierBlindModeDesc: 'Oculta el teclado.',
    modifierStrict: 'Strict',
    modifierStrictDesc: 'Sin retroceso (backspace).',
    modifierFlashlight: 'Flashlight',
    modifierFlashlightDesc: 'Solo se ve una pequeña zona del texto.',
    modifierDoubleTime: 'Double Time',
    modifierDoubleTimeDesc: 'Ritmo más rápido — solo en modo canción.',
    ...
    searchSongLyrics: 'Buscar canción',
    songMode: 'Canción',
    songModeHint: 'Escribe con la letra completa al ritmo del artista.',
    lyricsChangeTrack: 'Cambiar pista',
    lyricsTrackPace: '{wpm} PPM',
    lyricsWpmUnit: 'PPM',
    lyricsLoadedHint: 'Letra cargada desde LRCLIB — lista para la carrera.',
    lyricsSearchTitle: 'Resultados',
    lyricsSearchPlaceholder: 'Artista, canción o álbum…',
    ...
    lyricsSearchResults: 'Resultados de búsqueda de canciones',
    lyricsSearchKeyboardHint: 'Usa ↑ y ↓ para navegar, Enter para seleccionar.',
    lyricsWordCount: '{count} palabras',
