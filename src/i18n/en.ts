export const en = {
  ...
  home: {
    ...
    masteryRequirementsTest: 'Requires {wpm} WPM and {accuracy}% in Test mode',
    masteryRequirementsTestGrade: 'Requires {wpm} WPM, {accuracy}% and grade {grade}+ in Test mode',
  ...
  sandbox: {
    graduationBadge: 'Roadmap complete',
    title: 'Free training',
    desc: 'Configure your own session — time or word count, language, and modifiers.',
    sessionDesc: 'Sandbox session — no unlock pressure, just practice.',
    modeLabel: 'Mode',
    modeTime: 'Time',
    modeWords: 'Words',
  ...
  practice: {
    ...
    lyricsDirtyHint: 'Click or press Enter to start typing the lyrics',
    lyricsChangeSong: 'Change song',
  ...
  stats: {
    ...
    sortLabel: 'Sort by',
    sortWpmAsc: 'Weakest WPM first',
    sortWpmDesc: 'Best WPM first',
    sortAccAsc: 'Weakest accuracy first',
    ...
    insights: {
      needsSpeed: 'Needs speed',
      needsAccuracy: 'Needs accuracy',
      suggestedAdaptive: 'Suggested: Adaptive Drill',
      suggestedRetry: 'Suggested: Retry Lesson',
      focusOnKeys: 'Focus on: {keys}',
      improveOnLesson: 'Improve your score on {lesson}',
  ...
  settings: {
    ...
    hardwareLayout: 'Hardware layout',
    hardwareLayoutDesc: 'Physical key positions on the on-screen keyboard (Dvorak mapping stays the same).',
    hardwareLayoutAnsi: 'ANSI (US)',
    hardwareLayoutMacIso: 'ISO (Mac ES/EU)',
    osPreference: 'Operating system',
    osPreferenceDesc: 'Modifier key labels on the on-screen keyboard (⌘/⌥ vs Win/Alt).',
  ...
  completion: {
    ...
    noTroubleKeys: 'None',
    keystrokeDistribution: 'Keystroke distribution',
    keystrokesCorrect: 'Correct',
    keystrokesCorrected: 'Corrected',
    keystrokesErrors: 'Errors',
    keystrokesErrorsNa: 'Error count unavailable with stop-on-error enabled.',
    starsEarned: 'Stars earned',
  },
  history: {
    title: 'Session history',
    subtitle: 'Review your past typing sessions and drill into the details.',
    viewHistory: 'History',
    viewDetails: 'View details',
    closeDetails: 'Close',
    noSessions: 'No sessions yet. Complete a lesson to build your history.',
    emptyTitle: 'Your journey starts here',
    emptyDesc: 'Complete your first lesson and your sessions will appear in this carousel.',
    emptyCta: 'Start first lesson',
    loadingMore: 'Loading more sessions…',
    guestHint: 'Sign in to sync your session history across devices.',
    today: 'Today',
    yesterday: 'Yesterday',
    ...
    loadingTelemetry: 'Loading session analytics…',
